          ...
          <div class="items-center lg:flex">
            <div class="w-full lg:w-1/2">
              <div class="lg:max-w-lg">
                ...
                <button class="w-40 h-16 px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-yellow-500 rounded-md  hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600">
                  Donate
                </button>
              </div>
            </div>
